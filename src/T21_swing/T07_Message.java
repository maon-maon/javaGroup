...
//				JOptionPane.showMessageDialog(null, "경고합니다.");//(출력위치, 메세지) 화면출력=null
				JOptionPane.showMessageDialog(null, "경고합니다.","경고메세지", JOptionPane.WARNING_MESSAGE);//(화면위치, 메세지, 창의 제목, 아이콘)
			}
		});
		...
		btn4.addActionListener(new ActionListener() {
			...
			else lblMessage.setText("작업을 계속 진행합니다.");
			}
		});
