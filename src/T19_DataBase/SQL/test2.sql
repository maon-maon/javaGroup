...
insert into test values (default,'가나다',9,'여자','광주'); 
insert into test values (default,'라마바',15,default,'영주'); 
insert into test values (default,'바아자',22,'여자','전주'); 
insert into test values (default,'차카타',38,default,'광주'); 
insert into test values (default,'파 하',45,'남자','전주'); 
insert into test values (default,'알버트',49,'남자','천안'); 
insert into test values (default,'벤자민',51,'여자','천안'); 
insert into test values (default,'칼벤자민',51,'여자','대전'); 
insert into test values (default,'벤자민트',51,'여자','대전'); 
insert into test values (default,'캐롤린',21,'여자','청주'); 
insert into test values (default,'대니얼',28,'남자','청주'); 
insert into test values (default,'아야',28,'남자','청주'); 
insert into test values (default,'제키',40,'여자','청주'); 
-- default가 들어가면 idx가 자동으로 번호를 입력함
update test set age=35 where name ='김말숙';
